...
let musicall = [
    {id: "music-1",
     ...
     artist: "arjun",
     img: "./images/ithuvum kadanthu.jpg",
     link: "./musicname/Alaipaayum.mp3"
    },
    {id: "music-2",
     name: "Alaipaayum",
     artist: "arjun",
     img: "./images/Alaipayum.jpg",
     link: "./musicname/Alaipaayum.mp3"
    },
    {id: "music-3",
     name: "Azhage azhage",
     artist: "arjun",
     img: "./images/Azhage azhage.jpg",
     link: "./musicname/Azhage Azhage.mp3"
    ...
    {id: "music-4",
     name: "ennavale",
     artist: "arjun",
     img: "./images/Ennavale.jpg",
     link: "./musicname/Ennavale.mp3"
    ...
    {id: "music-5",
     name: "kanavellam",
     artist: "arjun",
     img: "./images/Kanavellam.jpg",
     link: "./musicname/Kanavellam.mp3"
    ...
    {id: "music-6",
     name: "kanukulla",
     artist: "arjun",
     img: "./images/Kanukulla.jpg",
     link: "./musicname/kannukulla.mp3"
    ...
    {id: "music-7",
     name: "mai potta",
     artist: "arjun",
     img: "./images/Mai pota.jpg",
     link: "./musicname/Mai Potta.mp3"
     ...
     name: "manasa yendi",
     artist: "arjun",
     img: "./images/Manasa yendi.jpg",
     link: "./musicname/Manasa Yendi.mp3"
